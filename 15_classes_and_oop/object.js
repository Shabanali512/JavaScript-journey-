...
const chai = new createUser("Shaban" , 25);
const Tea = new createUser("Ali" , 250);
...
// the newly created object , to the intended return value. 

// The new object is returned : After the constructor function has been called , if it doesn't return a non-primitve value 
